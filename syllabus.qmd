...
- **VS Code**: IDE for R, Quarto, and your Methods Vault workspace
...
- **v2v R Package**: R package with sampled practice fixtures and setup tools
- **Methods Vault**: VS Code course workspace, cloned from the GitHub template (see the [Resources](resources/) page)
