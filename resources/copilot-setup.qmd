...
:::{.pitfall}
Copilot will confidently suggest R functions that do not exist, or the wrong argument for one that does. Before you trust a suggestion, check it against the [textbook](https://aura-lab-siue.github.io/v2v/), the workbook, or the function's help page (`?function_name` in R).
:::
