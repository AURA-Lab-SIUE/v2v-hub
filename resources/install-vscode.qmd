...
VS Code (Visual Studio Code) is the editor you use for everything in this course: writing and running R, rendering Quarto documents, taking notes in your Methods Vault, and managing Git and GitHub. It is a professional, free, lightweight editor used by developers worldwide, and keeping all of your work in one editor means your code, your notes, and your reproducible report live together in a single workspace.
...
Open the Extensions view (`Ctrl/Cmd+Shift+X`) and install these. If you cloned the [Methods Vault](methods-vault-setup.qmd), it will simply prompt you to install its recommended set.
...
### 3. Foam — for your Methods Vault

Search for **Foam** and install. It adds `[[wiki-links]]`, a backlinks panel, and a graph view across your notes.

### 4. Markdown All in One

Search for **Markdown All in One** and install for table-of-contents, shortcuts, and list editing in Markdown.

### Optional: Python

If you ever branch into Python, install the **Python** extension by Microsoft. It is not required for this course.
...
1. **File, Open Folder** and choose a folder (for example, your cloned Methods Vault).
...
1. Installed VS Code.
2. Installed the R, Quarto, Foam, and Markdown extensions.
3. Connected GitHub.
4. Opened a workspace and ran R from the editor.
5. Next: finish [Install R](install-r.qmd), then set up your [Methods Vault](methods-vault-setup.qmd).
