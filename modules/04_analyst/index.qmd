...
This phase is where your research becomes quantitative. Weeks 11 to 13 each pair a concept session with a lab session on the same chapter, so you practice in class rather than only at home. These three assignments build on each other in sequence: the output of one is the input of the next.
