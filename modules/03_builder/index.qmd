...
**R Skills (Week 12):** Data wrangling, visualization, statistical testing — practice with the `twitch_chat_sample` / `twitch_streams_sample` datasets via the `v2v` package (loaders `twitch_chat()` / `twitch_streams()`)
