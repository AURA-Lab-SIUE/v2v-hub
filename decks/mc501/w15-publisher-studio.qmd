...
- I am circulating all evening. The more specific the question, the faster I can help, and
  a vague one is still worth asking if that is where you are.
...
- The idea predates Quarto and R. Runnable code and the prose explaining it belong in
  one document, an arrangement named **literate programming** (Knuth, 1984).
...
Methods carries the most weight because it carries the transparency markers: the
provenance statement, the reliability report, and the pre-registration
disclosure. The full rubric is in the syllabus.
