...
- Expect your first version of every figure to look wrong. That is what a first version is
  for, and the fix is usually one line rather than starting again.
...
*Two minutes on the last question, then we take it as a group.*
