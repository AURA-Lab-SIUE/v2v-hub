...
- Public, messy, and real, collected by automated process across six days
...
## Mark Weeks 5 and 9 now

Two weeks carry the term's weight, and both are visible from here:

- **Week 5** stacks the **Annotated Manuscripts** with **CITI Certification**
- **Week 9** carries the **Extended Codebook and Reliability Protocol**, 75 points,
  one week before the **Sampling Plan and Pilot**, also 75
- Those four middle weeks hold **200 points** between them
- **Start CITI in Week 1.** It is the one item that is pure clock time, and it is the
  only one you can finish before it is needed.
