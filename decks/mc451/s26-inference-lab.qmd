...
- If the phrase "run a statistical test" has been sitting in your stomach all term, today
  is smaller than you think. It is one function call and two sentences.
...
- Read your output back to yourself: the two means, the difference, *p*, and *d*
