...
Today looks like vocabulary and is actually a decision with consequences you will not see
until November.

The level you record a variable at determines which statistical tests are available to you
later. Choose narrowly now and your final paper is quietly forbidden from saying certain
things, and by then it is too late to recode two thousand messages.

You leave with a level assigned to every variable in your Definitions Practice.
...
*Three minutes. We will collect the ones that could be measured two ways.*
...
- Operationalize an interesting variable at nominal when it could have been ratio, and you
  have quietly narrowed what your study is able to conclude
- Nobody catches this at the time. It shows up in November as a test you are not allowed
  to run, on data you already spent forty hours coding.
- You make the choice **before coding a single case**, which is why it comes now
...
- Figure 8.2 draws this as four targets, from tight-on-center to scattered-and-off-center
- Do not let a consistent number persuade you that it is a correct one. Consistency is
  the easiest thing to mistake for accuracy.
