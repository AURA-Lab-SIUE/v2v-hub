...
- **Does it answer its own question?** Introduction and Discussion must match
- **Could someone repeat it?** Methods detailed enough to follow
- **Are the numbers right and complete?** Test statistic, *p*, and effect size
- **Is it honest?** Limits stated, effect size not inflated
- **Does it render and deploy?** A paper nobody can open scores nothing
