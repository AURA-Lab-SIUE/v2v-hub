...
Joins go wrong for everyone the first few times, and they go wrong quietly, which is worse.
The slide on what the join leaves behind is the one to pay attention to.
...
*Three minutes. We check your prediction in four slides.*
