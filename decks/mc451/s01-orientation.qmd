...
[A two-part content analysis]{.eyebrow}

- **Content analysis** is the method: turning messages into countable, defensible data
- **Phase one is qualitative.** You read real chat closely until you can say what is
  there, and write the memo that becomes your codebook
- **Phase two is quantitative.** You and a second coder apply that codebook, prove you
  agree on the numbers, and test relationships in R
- Every assignment this term is one piece of that study, in the order you need it

## The road from curiosity to claim

| Weeks | What you are doing |
|---|---|
| 1 to 4 | Tools, ethics, and finding the literature |
| 5 to 8 | Theory, research questions, and the prospectus |
| 8 to 11 | Building the codebook, testing it, drawing the sample |
| 11 to 13 | Wrangling, describing, and testing in R |
| 15 to 17 | Writing and publishing the White Paper |

Nothing here is a detour. Each row hands the next one its materials.
...
week across the 14 teaching weeks in Weeks 1 to 15, plus 10 for consistency,
**150 points**. It is the habit,
not a stage.
...
That is **125 points due Friday, November 6**, the heaviest week of the term.
The Sampling Plan gets an extra week because a pilot done properly takes one.
Put Week 11 in your calendar today and draft the sampling plan during Week 10.
...
- Skim **Chapter 1** on the course site: [aura-lab.siue.edu/v2v](https://aura-lab.siue.edu/v2v/)
