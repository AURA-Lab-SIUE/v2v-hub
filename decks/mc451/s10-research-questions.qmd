...
- **Measurable:** it must survive **operationalization**, the move from an abstract idea to
  something you can actually record
  - "Do authentic streamers build better communities?" cannot start until *authentic* and
    *better* become observable.
...
- **Circular question:** "Do popular creators attract large audiences because people want
  to watch them?"
...
- **Language analysis:** code what viewers write for intimacy and direct address.
  Naturalistic, and labor-intensive.
