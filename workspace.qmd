...
On the [v2v-workspace repository](https://github.com/AURA-Lab-SIUE/v2v-workspace), click **Use this template**, then **Create a new repository**. Name it `mc451-workspace` or `mc501-workspace`, and leave it **Public**. Your graded submission is the repository URL, so it has to be one anyone can open.
