...
| 3 | [Meet R](03-meet-r.qmd) | Set up R and your VS Code workspace |
...
| 7 | [Publishing](07-publishing.qmd) | Assemble your White Paper as a Quarto Book |
...
- [R Quick Reference](appendix-a-reference.qmd): common functions and syntax
...
The workbook is also available as a standalone Quarto Book. Download it from the [Resources](../resources/index.qmd) page or install the course R package to open the project files directly in VS Code.
:::
