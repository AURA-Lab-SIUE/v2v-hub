...
3. In VS Code, choose **File, Open Folder** and select the unzipped folder. The open folder is your working directory.
...
Copy your cleaned `.RDS` file (from Chapter 4 / the Data Wrangling assignment) into the project folder. The template's `03-results.qmd` expects a file called `coding_data_clean.RDS`, so rename yours to match, or update the filename in the code.
...
Or press `Ctrl/Cmd+Shift+K` with any `.qmd` file open. Quarto will:
...
### Introduction (01-introduction.qmd): 500 to 700 words
...
### Methodology (02-methodology.qmd): 400 to 600 words
...
### Results (03-results.qmd): code and interpretation
...
### Discussion (04-discussion.qmd): 400 to 500 words
...
### Abstract (index.qmd): about 150 words
...
1. **Download the template** and open the folder in VS Code.
