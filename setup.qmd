...
1. Open the [Methods Vault template repository](https://github.com/AURA-Lab-SIUE/v2v-methods-vault) on GitHub
2. Click the green **Use this template** button, then **Create a new repository**
3. Name your copy (for example, `methods-vault`) and create it under your own GitHub account
...
- **Foam**: note-linking, `[[wiki-links]]`, a backlinks panel, and a graph view
...
- Rename the copy something like `Week_01_MyName.md` and fill it out
